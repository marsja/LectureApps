...
\fancyfoot[CO,CE]{$if(cletter)$ Letter of Intent - $endif$ $if(CV)$ CV - $endif$ $if(vetenskap)$ Redog\"{o}relse f\"{o}r vetenskaplig verksamhet \\ $endif$ Erik Marsja - $if(DNR)$ DNR: $DNR$ - $endif$}
...
\textbf{Home Address}: & & $if(dob)$ \textbf{Personal Identity Number:} $endif$
