...
Marsja} | \textcolor{darkgray}{Sammanställning av Publikationer}}
...
Mina publikationer har baserats på experimentell metod och analys av
data från databas. I tabellen nedan finnes en sammanställning av
publikationer. Jag strävar efter att publicera min forskning open access
och reproducerbar när möjligt och detta bör vara tydligt i tabellen.
...
För en beskrivning av mina publikationer se dokumentet ``Nuvarande och
Planerad Forskning''. R-skript för Marsja et al.~(2022):
\url{https://github.com/marsja/EANDH-D-21-00145}, och R-skript och data
för Marsja et al.~(2018): \url{https://osf.io/amd2h/}. ``Reproducerbar''
i tabellen antyder dessa två publikationer, i dagsläget.
