...
Marsja} | \textcolor{darkgray}{Internationella samarbeten}}
...
\hypertarget{internationella-samarbeten}{%
\subsection{Internationella
Samarbeten}\label{internationella-samarbeten}}

\hypertarget{funktionsnedsuxe4ttning}{%
\subsubsection{Funktionsnedsättning}\label{funktionsnedsuxe4ttning}}

\begin{itemize}
\tightlist
\item
  Dr Antje Heinrich, Division of Human Communication, Development \&
  Hearing, University of Manchester, Manchester, UK
\item
  Dr Simon Sundström, Institutet för Specialpedagogik, Oslo
  Universitet\\
\end{itemize}

\hypertarget{psykologi}{%
\subsubsection{Psykologi}\label{psykologi}}

\begin{itemize}
\tightlist
\item
  Dr John Everett Marsh, School of Psychology, University of Central
  Lancashire, Preston, UK
\item
  Professor Jonathan Delafield-Butt, School of Education, University of
  Strathclyde, Glasgow, Skottland
\item
  Dr Christos Tachtatzis, Department of Electronic and Electrical
  Engineering, University of Strathclyde, Glasgow, Skottland
\end{itemize}
